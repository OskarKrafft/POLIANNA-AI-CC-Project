#!/usr/bin/env python3
# filepath: /Users/oskarkrafft/Desktop/Projects/POLIANNA-AI-CC-Project/src/visualize_ner_with_fit_for_55.py
"""
Visualization script for NER data with highlighting for 'Fit for 55' Policy Package.
Creates a figure with two subfigures:
1. Total NER entity counts by year
2. Normalized NER entity counts by year (entities per document)
"""
...
def create_ner_visualization_with_fit_for_55():
    ...
    # Create the visualization with two subfigures
    ...
    # Add a single legend for both plots with larger font size
    ...
    # Save the plot
    output_path = project_root / 'ner_entity_trends_fit_for_55_report.png'
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
    print(f"\nPlot saved to {output_path}")
    
    # Display the plot (if running in a notebook or interactive environment)
    # plt.show()

if __name__ == '__main__':
    create_ner_visualization_with_fit_for_55()
